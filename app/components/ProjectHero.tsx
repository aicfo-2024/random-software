  ...
  return (
    <div className="mb-16 rounded-lg border border-base-border bg-base-bg overflow-hidden md:shadow-xl">
      ...
      <div className="px-5 py-6 sm:px-8 sm:py-8 md:px-10">
        <h1 className="text-2xl sm:text-4xl md:text-display font-bold text-base-text mb-2">
          {title}
          {subtitle && (
        ...
        <p className="text-base md:text-xl text-base-text/70 leading-relaxed max-w-2xl">
          {description}
        </p>
      </div>
    </div>
